...
public class QuoteCursorAdapter extends CursorRecyclerViewAdapter<QuoteCursorAdapter.ViewHolder>
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final Cursor cursor) {
        ...
        viewHolder.parentView.setContentDescription(totalContentDescription);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder
        ...
        @BindView(R.id.stock_symbol) protected TextView symbol;
        @BindView(R.id.bid_price) protected TextView bidPrice;
        @BindView(R.id.change) protected TextView change;
